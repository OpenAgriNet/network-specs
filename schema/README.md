...
Use the [Schema Pack](schema/) to review every pack, its declared fields, its composition inputs, and its examples. Use the [Complete Examples](examples/) to see those packs inside Beckn Catalog, Provider, and Resource objects.
